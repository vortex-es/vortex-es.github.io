...
<div class="row all-pricing">
	<div class="row">
		<div class="col-sm-6 col-md-4 pricing">
			<div class="panel panel-info">
				...
				<ul class="list-group list-group-flush text-center">
					<li class="list-group-item"><i class="icon-ok text-info"></i> 24h-ahead wind stream-lines global map</li>
					<li class="list-group-item"><i class="icon-ok text-info"></i> Last quarter anomalies map (coming soon)</li>
					<li class="list-group-item"><i class="icon-ok text-info"></i> Next season forecasted anomalies (coming soon)</li>
				</ul>
		...
		<div class="col-sm-6 col-md-4 pricing pricing-featured">
			<div class="panel panel-info">
				<div class="panel-heading"><h3 class="text-center">FORECAST</h3></div>
				<div class="panel-body text-center">
				<p class="lead" style="font-size:40px"><strong>Extremely competitive</strong></p>
				</div>
				<ul class="list-group list-group-flush">
					<li class="list-group-item">Access via Vortex Interface</li>
					<li class="list-group-item">Retraining of forecasting free-of-cost</li>
